...
public class XMLDatabaseConnectionTest {

	private static ConnectionProperties conn;

	public static void main(String[] args) throws Exception {
		XMLDatabaseConnectionTest.run(conn = AuthenticationUtilities.loadProperties(), args);
	}

	public static void run(ConnectionProperties conn, String args[]) throws Exception {
		System.out.println("[INFO] " + XMLDatabaseConnectionTest.class.getSimpleName());
